...
\textbf{Efficiency}
  & $<$\$0.01 per task suite.  Runs in a browser, in JavaScript, on a CPU, on a phone, in airplane mode.  The NP-hard matching runs on commodity hardware---a MacBook Air's GPU found this proof of Wolstenholme's theorem.
