...
Deep Vision is the technology behind ARGO LABORATORY's entry to Chollet's ARC-AGI challenge~\cite{chollet_measure_2019}.  It represents a fundamentally different paradigm from deep learning.
...
\textbf{Efficiency}
  & $<$\$0.01 per ARC-AGI task suite (100s of tasks).  Runs in a browser, in JavaScript, on a CPU, on a phone, in airplane mode.  The NP-hard matching runs on commodity hardware---a MacBook Air's GPU found the proof of Wolstenholme's theorem.
